...
if __name__ == "__main__":
    ...
    parser.add_argument("--rig", default="vision", help="Rig name")
    ...
    participant_raw_dir = os.path.join(base_raw_dir, participant, rig)
    ...
    thermalA_folder = f"{base_raw_dir}/{participant}/{rig}/thermal/"
    sessions = {
    ...
    output_dir = os.path.join(participant_processed_dir, f"processed_thermal-{rig}_data")

    processed_videos = format_video_files(thermalA_folder, sessions, output_dir)
